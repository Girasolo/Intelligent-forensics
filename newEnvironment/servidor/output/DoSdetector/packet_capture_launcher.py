...
def main():
    ...
    try:
        ...
        while True:
        	packet_info = bpf["packet_info"].event()
        	print(f"Timestamp: {packet_info.timestamp}, Source IP: {packet_info.src_ip}, Destination IP: {packet_info.dst_ip}, Protocol: {packet_info.protocol}")
